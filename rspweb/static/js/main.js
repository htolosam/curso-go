...
let imgArray = ['static/img/hand_rock.png','static/img/hand_paper.png','static/img/hand_scissors.png']

function choose(choice){
    fetch('/play?playerChoice='+choice)
        .then( res => res.json())
        .then( data => {
            console.log(data)
...
function changeData(choice, data) {
   if (choice === 0) {
